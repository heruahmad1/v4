...
wget -q -O /etc/slowdns/server.key "https://raw.githubusercontent.com/heruahmad1/v4/main/slowdns/server.key"
wget -q -O /etc/slowdns/server.pub "https://raw.githubusercontent.com/heruahmad1/v4/main/slowdns/server.pub"
